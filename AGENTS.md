...
- The venv may reference a base Python installed outside the repository; this is normal. Run tests with `.\.venv\Scripts\python.exe -m unittest discover -s tests -v`.
